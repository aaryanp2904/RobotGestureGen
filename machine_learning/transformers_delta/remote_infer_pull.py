#!/usr/bin/env python3
"""Run delta-transformer inference on a remote GPU machine and pull outputs locally."""
...
DEFAULT_REMOTE_PRED_DIR = "/vol/bitbucket/ap1922/transformer_delta_predictions"
DEFAULT_CHECKPOINT = "/vol/bitbucket/ap1922/fyp_dataset/BEAT2_NAO_Transformer_Delta_Checkpoints/gesture_transformer_best.pth"
DEFAULT_STATS = "/vol/bitbucket/ap1922/fyp_dataset/BEAT2_NAO_Transformer_Delta_Preprocessed/normalization_stats.json"
...
def build_remote_infer_command(args: argparse.Namespace, remote_output: str) -> str:
    ...
    command = (
        ...
        f"{remote_quote(args.remote_python)} -m machine_learning.transformers_delta.inference "
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run remote delta-transformer inference and pull files locally")
    ...
    parser.add_argument("--local-dir", default="transformer_delta_predictions")
