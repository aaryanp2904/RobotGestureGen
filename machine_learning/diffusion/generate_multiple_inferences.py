#!/usr/bin/env python3
"""Generate diffusion predictions for multiple BEAT2 clips."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate diffusion predictions for multiple BEAT2 clips")
