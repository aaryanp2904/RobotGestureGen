...
DEFAULT_CHECKPOINT = f"{FYP_DATASET}/BEAT2_NAO_Diffusion_Checkpoints/diffusion_best.pth"
DEFAULT_STATS = f"{FYP_DATASET}/BEAT2_NAO_Diffusion_Preprocessed/normalization_stats.json"
