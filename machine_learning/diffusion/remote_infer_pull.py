#!/usr/bin/env python3
"""Run diffusion inference on a remote GPU machine and pull outputs locally."""
...
DEFAULT_REMOTE_PRED_DIR = "/vol/bitbucket/ap1922/diffusion_predictions"
DEFAULT_CHECKPOINT = "/vol/bitbucket/ap1922/diffusion_checkpoints/diffusion_best.pth"
DEFAULT_STATS = "/vol/bitbucket/ap1922/BEAT2_NAO_Diffusion_Preprocessed/normalization_stats.json"
...
def build_remote_infer_command(args: argparse.Namespace, remote_output: str) -> str:
    ...
    command = (
        ...
        f"{remote_quote(args.remote_python)} -m machine_learning.diffusion.inference "
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run remote diffusion inference and pull files locally")
    ...
    parser.add_argument("--local-dir", default="diffusion_predictions")
