#!/usr/bin/env python3
"""Plot Fréchet gesture distance metrics for Transformer predictions."""
...
CONFIG = ModelPlotConfig(
    ...
    color=ps.COLOR_TRANSFORMER,
    prediction_key="transformer",
)


def main() -> None:
    parser = build_arg_parser(
        "Plot Fréchet gesture distance for Transformer predictions vs ground truth",
        "--transformer-dir",
        "Directory containing Transformer prediction .npy files",
    )
    ...
    run_frechet_evaluation(
        ...
        prediction_dir=Path(args.transformer_dir),
