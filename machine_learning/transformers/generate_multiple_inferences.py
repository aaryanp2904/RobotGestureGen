#!/usr/bin/env python3
"""Generate transformer predictions for multiple BEAT2 clips."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate transformer predictions for multiple BEAT2 clips")
